...
# load data
text = load_text('combine_game_tinystory.txt')
...
model.fit(X0, Y0, batch_size=32, epochs=25, validation_data=(X1, Y1))#, callbacks=[early_stopping])

model.save('transformer_batch32_epoch55_seqlen60_2decoder_embedding64_headsize128_numhead3_dropout0.4_ffdim128_lr1e-4_tinystory.h5')
